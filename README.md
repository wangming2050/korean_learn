...
| 移动端打包说明 | `mobile/docs/MOBILE_BUILD.md` | 说明 Android APK/AAB 和 iOS 包的 EAS Build 打包方式 |
...
- 用户可导入自己的音标关联词汇、词汇资料和例句资料。
- 系统帮助用户为导入的词汇和例句生成韩语语音。
- 用户可以长期维护私人词汇库和私人例句库。
- 平台内容和用户内容可以一起学习，但数据归属需要区分。
...
3. 音标与词汇联动。
4. 词汇与例句联动。
5. 用户私人词汇库、例句库和导入内容语音生成。
6. 教材 AI 问本页增强。
7. AI 语音对话训练。
8. 教材文本转语音并加入例句库。
9. 语音评分和音标级反馈。
10. Web、iPhone、iPad 数据同步。
11. iPad 教材工作台。
12. 多人声、多语速、多语言支持。
