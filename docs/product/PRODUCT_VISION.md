...
- 文本转语音后，支持用户把文本以及语音添加到例句库中进行保存，构建自己的私人语句库进行学习
- 将教材和例句进行结合，数据之间同步，不孤立数据
- 支持用户导入自己的音标关联词汇、词汇资料和例句资料，系统帮助生成对应语音，形成用户自己的私人学习资料库。


价值：

- 教材文本内容直接转语音，补齐教材在听、说训练上的短板。
- 用户不再只能学习平台给出的内容，也可以把自己真实遇到的词汇、句子、教材内容沉淀到私人库中，持续维护自己的学习资料。
...
- 音标：支持用户自己添加或导入与某个音标相关的词汇，系统生成词汇语音后用于音标训练。
- 词汇：支持用户导入自己的词汇资料，系统生成词汇语音，并允许词汇继续关联例句。
- 例句：支持用户导入自己的例句资料，系统生成例句语音，供听读、跟读和后续语音评分使用。
- 教材：用户可以从教材页选中句子，保存到私人例句库，并生成对应语音。
- AI：用户可以把 AI 辅助生成的词汇或例句确认保存到私人库。
...
- 平台内容解决“从哪里开始学”，私人资料库解决“学我真正需要的内容”。
- 用户可以围绕自己的教材、考试、工作、生活场景维护长期词汇库和例句库。
- 系统生成语音后，私人内容也能进入听力、跟读、语音评分和 AI 对话训练，而不是只停留在文本收藏。
- 这项能力需要用户登录和数据同步支撑，是后续 Web、iPhone、iPad 三端一致体验的关键基础。

当前状态：

- 当前业务逻辑未实现。
- 需要在用户登录、用户数据归属、TTS 资源存储完成后进入实现阶段。
