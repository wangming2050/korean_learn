...
Avoid landing-page hero theatrics, gamified clutter, large decorative gradients, endless card catalogs, and dashboard density that makes language practice feel administrative.

## Design Principles

1. Training before browsing: show a concrete practice path before exposing the content library.
2. Small units, strong loops: make one sound, word, sentence, or scene feel complete enough to practice.
...
Use readable contrast in light and dark themes, visible focus states, non-color-only state cues, responsive layouts for phone and desktop, and motion that is short and tied to state changes.
